...
<tr>
 <td colspan="5">
  <a class="modal-trigger btn btn-primary" href="#modal1" style="background-color: #402407;">Take&nbsp;Action</a>
    ...
    <div class="modal-content" style="width:100%">
        <h4>Leave take action</h4>
          <select class="browser-default" name="status" required="">
                                        ...
                                        <p><textarea id="textarea1" name="description" class="materialize-textarea" name="description" placeholder="Description" length="500" maxlength="3500" required></textarea></p>
    </div>
