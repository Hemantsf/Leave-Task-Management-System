                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-content">
                             <span style="font-size:18px;"><b>Approved Leave History</b></span>
...
if($stats==1){
 ...
 <?php } ?>
           ...
           <td><a style="background-color: #402407;" href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-primary"  > View Details</a></td>
