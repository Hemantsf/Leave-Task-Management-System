...
<html lang="en">
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            ...
            <main class="mn-inner col-xl-12 ml-5">
...
?>
                                ...
                                <div class="determinate"   style="width: 70%;  background-color: #402407;"></div>
                            </div>
                        </div>
                    </div>
                        <div class="col-xl-4">
...
if($stats==1){
 ...
 <?php } ?>
           ...
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-primary" style="background-color: #402407; margin-right:0px;" > View Details</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
