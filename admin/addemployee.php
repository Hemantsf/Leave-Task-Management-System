...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col-xl-12">
                    <span style="font-size:18px;"><b>Add Employee</b></span>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addemp">
                                    <div>
                                       <span style="font-size:18px;"><b>Employee Info</b></span>
                                       <hr>
                                        <section>
...
<div class="input-field col-xl-12">
<button type="submit" name="add" onclick="return valid();" id="add" style="background-color: #402407;" class="btn btn-primary">ADD</button>
