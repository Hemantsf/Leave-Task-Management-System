                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <span style="font-size:18px;"><b>Add Leave Type</b></span>
                                        <hr>
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype"  required>
                                                <label for="leavetype" style="color: black">Leave Type</label>
                                            </div>


          <div class="input-field col-xl-12">
<textarea id="textarea1" name="description" class="materialize-textarea" name="description" length="500"></textarea>
                                                <label for="deptshortname" style="color: black">Description</label>
                                            </div>
...
<button type="submit" name="add" style="background-color: #402407;" class="btn btn-primary">ADD</button>
