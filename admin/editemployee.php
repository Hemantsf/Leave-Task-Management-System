...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col-xl-12">
                        <span style="font-size:18px;"><b>Update Employee</b></span>
                    <br>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <span style="font-size:18px;"><b>Update Employee Info</b></span>
...
<div class="input-field col-xl-12">
<button type="submit" name="update" style="color: white" id="update" class="btn btn-primary">UPDATE</button>
