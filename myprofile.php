...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-title"><b>Update employee</b></div>
                    </div>
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3><b>Update Employee Info</b></h3>
...
{               ?> 
 <div class="input-field col-xl-6">
...
<button type="submit" style="background-color: #402407;" name="update"  id="update" class="btn btn-primary">UPDATE</button>
